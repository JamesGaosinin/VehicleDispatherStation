...
const QMetaObject CDataBase::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CDataBase.data,
      qt_meta_data_CDataBase,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CDataBase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CDataBase.stringdata0))
        return static_cast<void*>(const_cast< CDataBase*>(this));
